...
from code.compressors.base import _ModelCompressor
from code.utils.arg_parser import BaseConfParser, r_getattr
from code.utils.module import camel_to_snake, load_all_direct_classes, load_all_submodules
...
class CompressionConfParser(BaseConfParser):
    ...
    def __init__(self, *args, **kwargs):
        ...
        stag, ltag = (f'/{tag}' for tag in tags) if tags else ('', '')
        ...
        for _, cls in chain.from_iterable(
            ...
            cls.add_options_to(
                arg_parser, pfxs=('cp', 'compression'), tags=tags)
