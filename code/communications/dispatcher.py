...
from code.utils.arg_parser import BaseConfParser
from code.communications.protocol import MessageType, Protocol
...
class ClientDispatcher:
    ...
    def send_msg(self, msg_type: MessageType, data: bytes):
        """
...
class _DispatcherConfParser(BaseConfParser):
    ...
    def __init__(self, *args, **kwargs):
        ...
        dispatcher_args.add_argument(
            ...
            default='/tmp/code/fed-comm.sock', type=str, metavar='ADDR',
            help="Socket address (unix socket only for local simulation,"
            "for cross-machine support, use tcp socket)")


class ServerDispatcherConfParser(_DispatcherConfParser):
...
class ClientDispatcherConfParser(_DispatcherConfParser):
