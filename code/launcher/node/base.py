...
from code.utils.training import init_excepthook
from code.utils.arg_parser import BaseConfParser, r_hasattr
...
alg_name_map: Dict[str, Type] = {
    ...
    for module in load_all_submodules(
        importlib.import_module(f"code.algorithms.{dir}"))
